...
const Wrapper = styled.div<Pick<Props, 'displayStyle'>>`
	width: 100%;
	display: flex;
	justify-content: ${(props) => (props.displayStyle ? displayStyles[props.displayStyle].justifyContent : displayStyles.flexLeft.justifyContent)};
	align-items: ${(props) => (props.displayStyle ? displayStyles[props.displayStyle].alignItems : displayStyles.flexLeft.alignItems)};
`;
...
export const Label = ({ text, displayStyle = 'flexLeft', isUnderlined = false } : Props) => (
